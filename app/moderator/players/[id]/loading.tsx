  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        <div className="h-8 w-24 rounded-lg bg-gray-200 animate-pulse motion-reduce:animate-none" />
        <div className="space-y-1">
          <div className="h-5 w-48 rounded bg-gray-200 animate-pulse motion-reduce:animate-none" />
